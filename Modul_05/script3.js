$(document).ready(function () {
  ...
  $("#alumniTable")
    ...
    .on("mouseleave", "img", function () {
      $(this).css({ transform: "scale(1)", filter: "brightness(1)" });
    })
    .on("mousedown", "img", function () {
      $(this).css({ transform: "scale(0.95)", filter: "brightness(0.8)" });
    })
    .on("mouseup", "img", function () {
      $(this).css({ transform: "scale(1)", filter: "brightness(1)" });
    })
    .on("dblclick", "img", function () {
      $(this).css({ transform: "rotate(15deg)", filter: "brightness(1.2)" });
      setTimeout(() => {
        $(this).css({ transform: "rotate(0deg)", filter: "brightness(1)" });
      }, 500);
    });
